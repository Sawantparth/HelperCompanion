...
from utils.simple_auth import is_authenticated, get_current_user
import os
...
def main():
    ...
    with st.sidebar:
        ...
        if user_info:
            st.markdown("---")
            st.markdown(f"**Logged in as:** {user_info.get('email', 'Unknown')}")
        ...
        if st.button("🚪 Logout", type="secondary"):
            from components.simple_auth import logout_user
            logout_user()
